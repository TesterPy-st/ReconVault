...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, connection_id: Optional[str] = None) -> str:
        ...
        logger.info(f"WebSocket connected: {connection_id} from {self.connection_metadata[connection_id]['client_ip']}")
    ...
    def disconnect(self, connection_id: str, reason: str = "Client disconnected") -> None:
        """
    ...
    async def broadcast(self, message: Dict[str, Any], exclude_connection_ids: Optional[Set[str]] = None) -> int:
        """
    ...
    async def send_to_connections(self, connection_ids: List[str], message: Dict[str, Any]) -> int:
        """
    ...
    def get_connection_stats(self) -> Dict[str, Any]:
        ...
        avg_messages = total_messages / len(self.connection_metadata) if self.connection_metadata else 0
        ...
        return {
            ...
            "connection_usage_percent": (len(self.active_connections) / self.connection_limit) * 100
        }
...
class WebSocketService:
    ...
    async def broadcast_target_update(self, target_data: Dict[str, Any], event_type: str = "target_updated") -> int:
        """
    ...
    async def broadcast_entity_update(self, entity_data: Dict[str, Any], event_type: str = "entity_updated") -> int:
        """
    ...
    async def broadcast_intelligence_update(self, intelligence_data: Dict[str, Any], event_type: str = "intelligence_updated") -> int:
        """
    ...
    async def broadcast_graph_update(self, graph_data: Dict[str, Any], event_type: str = "graph_updated") -> int:
        """
    ...
    async def broadcast_system_alert(self, alert_data: Dict[str, Any], severity: str = "info") -> int:
        """
    ...
    async def send_personal_notification(self, connection_id: str, notification_data: Dict[str, Any]) -> bool:
        """
        ...
        return await self.connection_manager.send_personal_message(connection_id, message)
    ...
    def cleanup_inactive_connections(self, max_inactive_minutes: int = 30) -> int:
        ...
        Returns:
            int: Number of connections cleaned up
        """
        return self.connection_manager.cleanup_inactive_connections(max_inactive_minutes)
