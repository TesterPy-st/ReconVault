...
class AuditLog(Base):
    ...
    severity = Column(
        String(20), default=AuditSeverity.INFO, nullable=False, index=True
    )
    ...
    meta = Column(Text, nullable=True)  # JSON string for additional metadata
    ...
    def is_security_related(self) -> bool:
        ...
        return (
            self.action in security_actions
            or self.severity in [AuditSeverity.CRITICAL, AuditSeverity.HIGH]
    ...
    def requires_review(self) -> bool:
        ...
        return (
            ...
            or self.status == AuditStatus.FAILED
            or self.is_security_related()
            or self.risk_score >= 0.6
        )
